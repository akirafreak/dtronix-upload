namespace dtxUpload {
	partial class frmDropBox {
		...
		private void InitializeComponent() {
			...
			this.label1.Text = "Drop Files To Upload";
			// 
			// notifyIcon
			// 
			...
			this.DragDrop += new System.Windows.Forms.DragEventHandler(this.frmDropBox_DragDrop);
			this.DragEnter += new System.Windows.Forms.DragEventHandler(this.frmDropBox_DragEnter);
